...
--               d:/expriment/new/axi_stream_machine/axi4stream_vip_mst_0/axi4stream_vip_mst_0_sim_netlist.vhdl
...
entity axi4stream_vip_mst_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of axi4stream_vip_mst_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of axi4stream_vip_mst_0 : entity is "axi4stream_vip_mst_0,axi4stream_vip_v1_1_17_top,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of axi4stream_vip_mst_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of axi4stream_vip_mst_0 : entity is "axi4stream_vip_v1_1_17_top,Vivado 2024.1";
end axi4stream_vip_mst_0;

architecture STRUCTURE of axi4stream_vip_mst_0 is
  ...
  attribute X_INTERFACE_PARAMETER of m_axis_tlast : signal is "XIL_INTERFACENAME M_AXIS, TDATA_NUM_BYTES 6, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, LAYERED_METADATA undef, INSERT_VIP 0";
