...
synth_design -top stream_processor -part xc7z020clg400-1
...
write_checkpoint -force -noxdef stream_processor.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file stream_processor_utilization_synth.rpt -pb stream_processor_utilization_synth.pb"  } 
